package com.example.trackandtrigger.Adapter;
...
public class EventAdapter extends RecyclerView.Adapter<com.example.trackandtrigger.Adapter.EventAdapter.ViewHolder> {
    Context context;
