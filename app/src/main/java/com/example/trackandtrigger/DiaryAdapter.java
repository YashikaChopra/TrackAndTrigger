...
public  class DiaryAdapter extends RecyclerView.Adapter<com.example.trackandtrigger.DiaryAdapter.DiaryViewHolder> {
        ...
        DiaryViewHolder(View view){
            ...
            containerView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Diary current=(Diary) containerView.getTag();
                    Intent a= new Intent(v.getContext(),Diary_Activity2.class);
    ...
    public void onBindViewHolder(@NonNull DiaryViewHolder holder, int position) {
        Diary current= diary.get(position);
    ...
    public void reload(){
        diary= com.example.trackandtrigger.Diary_Activity.database.diaryDAO().getAlldiary();
